...
internal data class BuildDifference(val ts: Long, val isIncremental: Boolean, val dirtyData: DirtyData)

// todo: storage format can be optimized by compressing fq-names
internal data class BuildDiffsStorage(val buildDiffs: List<BuildDifference>) {
    companion object {
        ...
        @set:TestOnly
        internal var CURRENT_VERSION: Int = 0
    }
}